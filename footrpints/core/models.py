...
class OfficialAlumni(models.Model):
    ...
    personalmail = models.EmailField(db_column='personalMail', max_length=40, blank=True, null=True) 
    batchid = models.ForeignKey(Batches, models.PROTECT, db_column='batchId', blank=True, null=True)  
